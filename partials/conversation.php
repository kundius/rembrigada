<div class="conversion conversion--widget">
                ...
                <div class="conversion__item col-lg-6 col-md-6 col-sm-6 col-xs-6">
                  <div class="conversion__item-inner">
                    ...
                    <div class="conversion__item-content">
                      <a class="conversion__item-btn conversion__item-btn--calculator-design call-wqec" 
                         data-wqec-section-id="4927" 
                         href="#">
  ...
  <!-- Кнопка-триггер -->
  <div class="conversion__btn conversion__btn--gray">
