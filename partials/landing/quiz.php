...
<section class="landing-quiz" id="quiz">
  <div class="container container_medium">
    ...
    <div class="quiz" data-quiz>
      ...
      <form action="/wp-json/contact-form-7/v1/contact-forms/4295/feedback" method="post" class="quiz-layout js-form" data-quiz-form data-ym-goal="<?php echo $quiz['goal'] ?>">
