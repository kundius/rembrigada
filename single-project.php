                                                ...
                                                <div class="project-modal-layout">
                                                    ...
                                                    <div class="project-modal-layout__right">
                                                        <div class="project-modal__nav">
                                                            <div class="slide-nav">
                                                                <button class="slide-nav__button slide-nav__button_prev js-project-modal-nav" data-target="project-<?php echo get_prev_id($gallery, $item['id']) ?>" data-current="project-<?php echo $item['id'] ?>" data-micromodal-close></button>
                                                                <button class="slide-nav__button slide-nav__button_next js-project-modal-nav" data-target="project-<?php echo get_next_id($gallery, $item['id']) ?>" data-current="project-<?php echo $item['id'] ?>" data-micromodal-close></button>
                                                            </div>
                                                        </div>
                                                        <div>
